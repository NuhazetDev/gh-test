...
var _pokemonJs = require("./Pokemon.js");
var _pokemonJsDefault = parcelHelpers.interopDefault(_pokemonJs);
...
const startPokedex = async ()=>{
    ...
    // Convertimos la respuesta de la API en un objeto JSON
        ...
        const data = result;
        const pokemon = new (0, _pokemonJsDefault.default)(data);
        pushPokemon(pokemon);
...
},{"./Pokemon.js":"7cCsW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7cCsW":[function(require,module,exports,__globalThis) {
